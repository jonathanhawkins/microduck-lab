...
export const MARS_COLORWAYS: Record<string, MarsColorway> = {
  ...
  white: { id: "white", label: "White", accent: "#c9ccd3", body: "#eceef2" },
};

/** Innate's hero shell, and the one the server already paints (orange links
 *  on a dark chassis) — so an unlabelled slot looks like the press photo. */
export const MARS_DEFAULT_COLORWAY = "orange-black";
